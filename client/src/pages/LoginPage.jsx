      ...
      <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          ...
          {currState=== "Sign up" && !isDataSubmitted && (
            ...
            type='text' className='p-2 border border-gray-500 bg-transparent rounded-md focus:outline-none' placeholder='Full Name' required/>
          ...
          {!isDataSubmitted && (
            ...
            type="email" placeholder='Email Address' required className='p-2 border border-gray-500 bg-transparent
            rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' />

             <input onChange={(e)=>setPassword(e.target.value)} value={password}
            type="password" placeholder='password' required className='p-2 border border-gray-500 bg-transparent
            rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500' />
...

          {
            currState === "Sign up" && isDataSubmitted && (
              ...
              rows={4} className='p-2 border border-gray-500  bg-transparent rounded-md focus:outline-none focus:ring-2 
