    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          type="text" required placeholder='Your name' className='p-2 bg-transparent border border-gray-500 rounded-md focus:outline-none focus:ring-2
          focus:ring-violet-500'/>
          <textarea onChange={(e)=>setBio(e.target.value)} value={bio} placeholder='write profile bio' required className='p-2 bg-transparent border border-gray-500 rounded-md focus:outline-none focus:ring-2
